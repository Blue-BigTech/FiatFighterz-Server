...
namespace World.Looting
{
    public class Tier : Loot, ILootable
    {
        ...
        public static Tier Weapon(int chance, ItemTier tier) => new Tier(chance, tier, SlotType.Sword, SlotType.Bow, SlotType.Claymore, SlotType.Spear, SlotType.Elixir, SlotType.Crossbow, SlotType.Staff);
